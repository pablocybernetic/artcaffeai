...
from table_booking_routes import router as table_bookings_router, public_router as table_bookings_public_router
...
app.include_router(table_bookings_router)
app.include_router(table_bookings_public_router)
